workspace {
    ...
    views {
        container softwareSystem "all_containers" {
            include *
            autolayout
        }

        container softwareSystem "container_service_1" {
            include ->softwareSystem.service1->
            autolayout
        }

        container softwareSystem "container_service_2" {
            include ->softwareSystem.service2->
            autolayout
        }

        container softwareSystem "container_service_3" {
